 ...
 * 03/01/2010
 */
public class FileDownloadRequestImpl extends AbstractFileRequest {
	private static final Logger LOGGER = Logger.getLogger(FileDownloadRequestImpl.class);
	
	public FileDownloadRequestImpl(EventDTO inputEvent, Map<String, String> inputHttpEnv) {
