 ...
 * 03/01/2010
 */
public class FileDetailRequestImpl extends AbstractFileRequest {
	private static final Logger LOGGER = Logger.getLogger(FileDetailRequestImpl.class);
	
	public FileDetailRequestImpl(EventDTO inputEvent, Map<String, String> inputHttpEnv) {
